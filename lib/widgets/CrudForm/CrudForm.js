...
import {initialize, change} from 'redux-form/lib/actions';
...
class CrudForm extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if ((!prevFormValues.moduleId || !prevFormValues.controllerName)
            ...
            this.props.dispatch(initialize(CrudForm.formId, values));
        }
        ...
        if (_get(prevFormValues, 'meta.modelClassName') !== _get(nextFormValues, 'meta.modelClassName')) {
            ...
            this.props.dispatch(change(CrudForm.formId, 'meta.modelAttributes', attributes));
        }
        ...
        if (_get(prevFormValues, 'meta.formModelClassName') !== _get(nextFormValues, 'meta.formModelClassName')) {
            ...
            const attributes = model
                ...
                : [];
            this.props.dispatch(change(CrudForm.formId, 'meta.formModelAttributes', attributes));
        }
    }
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-10 col-md-8 col-lg-6'>
                        <Field
                            name='moduleId'
                            component='input'
                            list={`${CrudForm.formId}_moduleIdList`}
                            className='form-control'
                        />
                        <datalist id={`${CrudForm.formId}_moduleIdList`}>
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-10 col-md-8 col-lg-6'>
                        <Field
                            ...
                            component='input'
                            list={`${CrudForm.formId}_modelNameList`}
                            className='form-control'
                        />
                        <datalist id={`${CrudForm.formId}_modelNameList`}>
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-10 col-md-8 col-lg-6'>
                        <Field
                            ...
                            component='input'
                            list={`${CrudForm.formId}_formModelNameList`}
                            className='form-control'
                        />
                        <datalist id={`${CrudForm.formId}_formModelNameList`}>
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-10 col-md-8 col-lg-6'>
                        <Field
                            ...
                            className='form-control'
                            placeholder='*'
                            list={`${CrudForm.formId}_rolesList`}
                        />
                        <datalist id={`${CrudForm.formId}_rolesList`}>
                            <option value='@'/>
                            <option value='admin'/>
                        </datalist>
                    </div>
...
const selectorFormValues = getFormValues(CrudForm.formId);
export default __appWidget.register('\\extpoint\\yii2\\gii\\widgets\\CrudForm\\CrudForm', connect(
    state => ({
        formValues: selectorFormValues(state),
    })
)(reduxForm({
    form: CrudForm.formId,
})(CrudForm)));